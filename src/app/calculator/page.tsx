  ...
  return (
    ...
    >
      ...
      <motion.header
        ...
        className="relative top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border/50"
      >
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <motion.div
              ...
              className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full border border-border bg-card/50 backdrop-blur-sm"
            >
      ...
      {/* Main Content */}
      <div className="min-h-screen px-4 sm:px-6 lg:px-8 py-6 lg:py-8 flex gap-4">
        {/* Left Panel - Calculator Form */}
        <div className="space-y-5 overflow-scroll lg:pr-2 scrollbar-thin max-h-screen">
          ...
          <AnimatePresence mode="wait">
            {routeInfo && (
              ...
              >
                <Card className="p-5 shadow-lg border-primary/20 bg-gradient-to-br from-primary/5 via-primary/[0.02] to-transparent">
              ...
              >
                <Card className="p-6 shadow-2xl border-0 bg-foreground text-background relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <Button
                      size="lg"
                      className="w-full bg-primary text-primary-foreground hover:bg-primary/90 group h-14 text-base rounded-xl relative overflow-hidden"
                    >
                      <motion.span
            ...
            {!routeInfo && (
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <Route className="w-14 h-14 mx-auto mb-4 text-muted-foreground/30" />
                </motion.div>
        ...
        <motion.div
          ...
          className="flex-1 rounded-3xl overflow-hidden shadow-2xl border border-border/50"
        >
          <MapboxRouteMap
