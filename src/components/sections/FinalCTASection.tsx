...
export function FinalCTASection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-28 relative overflow-hidden">
      ...
      <motion.div style={{ y, opacity }} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
        ...
        >
          ...
          >
            {/* App Store */}
            <motion.div
              className="flex items-center gap-3 bg-foreground text-background rounded-xl px-5 py-3 cursor-pointer relative overflow-hidden group"
