    ...
    <section className="py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-primary to-primary/80 p-10 lg:p-16"
        >
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              >
                ...
                <div className="flex items-center gap-3 mt-8">
                  ...
                  <span className="text-white/80 text-sm">{t("reviews")}</span>
                </div>
              </motion.div>
            </div>
            ...
            >
              {/* App Store */}
              <div className="flex items-center gap-4 bg-black/20 backdrop-blur-sm rounded-2xl px-6 py-4 hover:bg-black/30 transition-colors cursor-pointer">
                ...
                <div>
                  <p className="text-white/60 text-xs">{t("downloadAppStore")}</p>
                  <p className="text-white font-semibold text-lg">{t("appStore")}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-black/20 backdrop-blur-sm rounded-2xl px-6 py-4 hover:bg-black/30 transition-colors cursor-pointer">
                ...
                <div>
                  <p className="text-white/60 text-xs">{t("getItOn")}</p>
                  <p className="text-white font-semibold text-lg">{t("googlePlay")}</p>
                </div>
              </div>
            </motion.div>
          </div>
